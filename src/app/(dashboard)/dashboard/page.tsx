    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">Bienvenido, {session?.email.split('@')[0]}</h2>
                    <p className="text-slate-500 dark:text-slate-400">Aquí tienes un resumen de lo que está pasando hoy.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-4xl font-bold text-primary">$45,200</div>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 font-medium">Todos los servicios operativos</p>
                    </CardContent>
                </Card>
            </div>
                ...
                <CardContent>
                    <div className="space-y-4">
                        <p className="text-slate-600 dark:text-slate-300">
                            Has iniciado sesión exitosamente como <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-primary font-bold">{session?.role}</code>.
                        ...
                        <ul className="list-disc list-inside space-y-2 text-slate-600 dark:text-slate-300">
                            ...
                            <li>Revisa la documentación en <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded">DOC-COMPONENT.md</code></li>
                        </ul>
                    </div>
                </CardContent>
            </Card>
